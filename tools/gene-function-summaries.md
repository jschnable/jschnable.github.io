  ...
  <section class="maize-synth-search" aria-labelledby="maize-synth-search-title">
    ...
    <form id="maize-synth-form" class="maize-synth-form">
      ...
      <div class="maize-synth-input-row">
        <input id="maize-synth-query" name="query" type="search" autocomplete="off" spellcheck="false" placeholder="Zm00001eb237930, GRMZM2G120408, Sobic.001G000100">
...
<script src="{{ site.baseurl }}/assets/js/gene-function-summaries.js" defer></script>
